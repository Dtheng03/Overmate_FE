            ...
            <Tabs defaultValue="Đăng ký với sự yên tâm" className="">
                ...
                <TabsContent value="Đăng ký với sự yên tâm">
                    <div className="p-[5%] rounded-[12px] bg-color4/40">
                        <h2 className="mb-8 text-2xl md:text-3xl text-color2 font-bold">Đăng ký với yên tâm</h2>
                        <div className="mb-4">
                            <h4 className={h4}>
                                <StarIcon fill="purple" height={20} width={20} />
                ...
                <TabsContent value="Nổi bật ngay từ đầu">
                    <div className="p-[5%] rounded-[12px] bg-color4/40">
                        <h2 className="mb-8 text-2xl md:text-3xl text-color2 font-bold">Nổi bật ngay từ đầu</h2>
                        <div className="flex flex-col md:flex-row gap-y-8 md:gap-x-8 justify-center">
                            <div className="basis-full md:basis-2/5 mb-4 flex flex-col items-center">
                                ...
                                <p className="text-sm text-center">
                                    Chúng tôi nhập điểm đánh giá của bạn từ các nền tảng khác và hiển thị trên trang <span className="text-color2">Overmate</span> cho bạn, do đó bạn sẽ không bắt đầu từ con số 0.
                                </p>
                            </div>
                            <div className="basis-full md:basis-2/5 mb-4 flex flex-col items-center">
