...
import { AddMoney, EditIcon } from "@/components/icons/commons";
...
function MyAccount() {
    ...
    return (
        <section className="px-[10%] py-[5%] bg-color1 bg-[url('./assets/imgs/background.png')] bg-cover bg-center" >
            ...
            <div className="mt-8 mx-auto w-[800px] p-0.5 rounded-[20px] bg-gradient-to-r from-[#011949] to-[#55A6CE]">
                <div className={card}>
                    <h3 className="mb-4 text-white font-bold text-xl sm:text-2xl text-center">Tài khoản</h3>
                    <p className="flex items-center justify-center gap-x-4 text-white font-semibold text-lg">
                        <AddMoney fill="white" width={20} height={20} />
                        {data?.data?.value?.balance?.toLocaleString()} đ
                    </p>
                </div>
            </div>
            <div className="mt-8 flex flex-col lg:flex-row justify-evenly gap-8">
                        ...
                        <div className={content}>
                            ...
                            {data?.data?.value?.mbti == "Bạn cần phải trả lời các câu hỏi đánh giá tính các MBTI" &&
                                <div className="mt-12 flex justify-center">
                                    <Button
                                        className="bg-color2 hover:bg-color3"
                                        disabled
                                    >
                                        <Link to={"#"}>Chưa hỗ trợ cho đối tác</Link>
                                    </Button>
                                </div>
                            }
                        </div>
